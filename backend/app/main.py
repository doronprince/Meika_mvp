...
from app.routers import auth, chat, dashboard, expense, fx, goals, health, income, price_finder, survival, users, ws_copilot
...
def create_application() -> FastAPI:
    ...
    application.include_router(income.router, prefix=settings.api_v1_prefix)
    application.include_router(survival.router, prefix=settings.api_v1_prefix)
